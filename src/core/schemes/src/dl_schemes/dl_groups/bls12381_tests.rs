...
fn test_bls12381_equals() {
    let x = Bls12381::new_rand(&mut RNG::new( RngAlgorithm::OsRng));
...
fn test_bls12381_ecp2_equals() {
    let x = Bls12381ECP2::new_rand(&mut RNG::new( RngAlgorithm::OsRng));
...
fn test_bls12381_fp12_equals() {
    let x = Bls12381FP12::new_rand(&mut RNG::new( RngAlgorithm::OsRng));
