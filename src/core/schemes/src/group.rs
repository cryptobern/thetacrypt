...
impl Clone for GroupElement {
    fn clone(&self) -> Self {
        unsafe {
            match self.group {
                Group::Bls12381 => GroupElement {
                    group: self.group.clone(),
                    data: GroupData {
                        bls12381: self.data.bls12381.clone(),
                    },
                },
                Group::Bn254 => GroupElement {
                    group: self.group.clone(),
                    data: GroupData {
                        bn254: self.data.bn254.clone(),
                    },
                },
                Group::Ed25519 => GroupElement {
                    group: self.group.clone(),
                    data: GroupData {
                        ed25519: self.data.ed25519.clone(),
                    },
                },
                _ => {
                    todo!();
...
impl GroupElement {
    ...
    pub fn identity(group: &Group) -> GroupElement {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::identity()),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::identity()),
                }
            }
            Group::Ed25519 => {
                data = GroupData {
                    ed25519: ManuallyDrop::new(Ed25519::identity()),
                }
            }
            _ => todo!(),
        }
    ...
    pub fn new(group: &Group) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new()),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new()),
                }
            }
            Group::Ed25519 => {
                data = GroupData {
                    ed25519: ManuallyDrop::new(Ed25519::new()),
                }
            }
            _ => todo!(),
        }
    ...
    pub fn new_ecp2(group: &Group) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new_ecp2()),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new_ecp2()),
                }
            }
        ...
        unsafe {
            match self.get_group() {
                Group::Bls12381 => {
                    ...
                    GroupElement {
                        group: Group::Bls12381,
                        data: GroupData {
                            bls12381: ManuallyDrop::new(res),
                        },
                    }
                }
                Group::Bn254 => {
    ...
    pub fn new_hash(group: &Group, hash: &[u8]) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new_from_ecp(
            ...
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new_from_ecp(
                        mcore::bn254::bls::bls_hash_to_point(hash),
                    )),
                }
            }
    ...
    pub fn new_pow_big(group: &Group, y: &BigImpl) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new_pow_big(y)),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new_pow_big(y)),
                }
            }
            Group::Ed25519 => {
                data = GroupData {
                    ed25519: ManuallyDrop::new(Ed25519::new_pow_big(y)),
                }
            }
            _ => todo!(),
        }
    ...
    pub fn new_pow_big_ecp2(group: &Group, y: &BigImpl) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new_pow_big_ecp2(y)),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new_pow_big_ecp2(y)),
                }
            }
    ...
    pub fn new_rand(group: &Group, rng: &mut RNG) -> Self {
        ...
        match group {
            Group::Bls12381 => {
                data = GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::new_rand(rng)),
                }
            }
            Group::Bn254 => {
                data = GroupData {
                    bn254: ManuallyDrop::new(Bn254::new_rand(rng)),
                }
            }
            Group::Ed25519 => {
                data = GroupData {
                    ed25519: ManuallyDrop::new(Ed25519::new_rand(rng)),
                }
            }
            _ => todo!(),
        }
    ...
    pub fn from_bytes(bytes: &[u8], group: &Group, i: Option<u8>) -> Self {
        ...
        match group {
            Group::Bls12381 => Self {
                group: group.clone(),
                data: GroupData {
                    bls12381: ManuallyDrop::new(Bls12381::from_bytes(bytes, j)),
                },
            },
            Group::Bn254 => Self {
                group: group.clone(),
                data: GroupData {
                    bn254: ManuallyDrop::new(Bn254::from_bytes(bytes, j)),
                },
            },
            Group::Ed25519 => Self {
                group: group.clone(),
                data: GroupData {
                    ed25519: ManuallyDrop::new(Ed25519::from_bytes(bytes)),
                },
            },
            _ => todo!(),
        }
